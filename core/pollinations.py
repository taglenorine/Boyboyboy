...
- [VISION]: Menganalisis gambar dari URL yang diberikan. \
Format: [CALL_TOOL: vision | url: <url_gambar> | prompt: <pertanyaan> | model: openai]
- [VIDEO_GEN]: Menghasilkan video MP4 pendek. \
(Model: veo – HANYA UNTUK PREMIUM/BYOP).
- [AUDIO_TTS]: Mengubah teks menjadi suara MP3. \
Format: [CALL_TOOL: audio_tts | text: <teks> | voice: alloy]
- [AUDIO_STT]: Mentranskrip pesan suara Telegram menjadi teks. \
(Ditangani otomatis saat pengguna mengirim pesan suara).
...
[CALL_TOOL: audio_tts | text: <teks> | voice: alloy]
[CALL_TOOL: vision | url: <image_url> | prompt: <question> | model: openai]
